var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code_1, file$1, 13, 4, 278);
    			...
    			add_location(div1, file$1, 10, 0, 175);
    		},
    ...
    class Code extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { code: 0, asResponse: 1 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 69, 4, 1384);
    			attr_dev(div, "class", "white-box svelte-1ekdgee");
    			add_location(div, file, 70, 4, 1487);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "input-box svelte-1ekdgee");
    			attr_dev(input, "placeholder", "Type your question here");
    			add_location(input, file, 66, 4, 1235);
    			attr_dev(div1, "class", "white-box svelte-1ekdgee");
    			add_location(div1, file, 67, 4, 1338);
    		},
    		m: function mount(target, anchor) {
