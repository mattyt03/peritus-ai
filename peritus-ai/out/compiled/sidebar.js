var app = (function () {
    ...
    /* webviews/components/Home.svelte generated by Svelte v3.55.1 */
    const file$1 = "webviews/components/Home.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Peritus";
    			t1 = space();
    			button = element("button");
    			button.textContent = "Debug";
    			attr_dev(h1, "class", "svelte-urxgee");
    			add_location(h1, file$1, 5, 0, 59);
    			attr_dev(button, "class", "svelte-urxgee");
    			add_location(button, file$1, 7, 0, 77);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (122:2) {#each responses as res (res.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(122:2) {#each responses as res (res.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(body, file, 113, 0, 3977);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(home, body, null);
    			append_dev(body, t0);
