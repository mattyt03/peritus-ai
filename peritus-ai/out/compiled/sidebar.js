var app = (function () {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$5, 40, 6, 1011);
    			attr_dev(button1, "class", "btn svelte-182cie6");
    			add_location(button1, file$5, 43, 6, 1136);
    			attr_dev(div, "class", "btn-container svelte-182cie6");
    			add_location(div, file$5, 39, 4, 977);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*asResponse*/ ctx[1] && /*showButtons*/ ctx[4] && create_if_block$4(ctx);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 30, 2, 851);
    			attr_dev(div0, "class", "prompt svelte-1ttv9v8");
    			add_location(div0, file$1, 35, 2, 1013);
    			attr_dev(div1, "class", "response svelte-1ttv9v8");
    			add_location(div1, file$1, 36, 2, 1050);
    			attr_dev(div2, "class", "container svelte-1ttv9v8");
    			add_location(div2, file$1, 29, 0, 825);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (207:2) {#each responses as res (res.id)}
    function create_each_block(key_1, ctx) {
    	...
    	response = new Response({
    			props: {
    				id: /*res*/ ctx[22].id,
    				prompt: /*res*/ ctx[22].prompt,
    				result: /*res*/ ctx[22].result,
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const response_changes = {};
    			if (dirty & /*responses*/ 8) response_changes.id = /*res*/ ctx[22].id;
    			if (dirty & /*responses*/ 8) response_changes.prompt = /*res*/ ctx[22].prompt;
    			if (dirty & /*responses*/ 8) response_changes.result = /*res*/ ctx[22].result;
    			response.$set(response_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(207:2) {#each responses as res (res.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	if (/*scope*/ ctx[2] !== void 0) {
    		input_props.scope = /*scope*/ ctx[2];
    	}
    	...
    	let if_block = /*loading*/ ctx[4] && create_if_block(ctx);
    	let each_value = /*responses*/ ctx[3];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*res*/ ctx[22].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(body, file, 195, 0, 8186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_scope && dirty & /*scope*/ 4) {
    				updating_scope = true;
    				input_changes.scope = /*scope*/ ctx[2];
    			...
    			if (/*loading*/ ctx[4]) if_block.p(ctx, dirty);

    			if (dirty & /*responses, handleRemove, copyCode, replaceInFile*/ 456) {
    ...
    function instance($$self, $$props, $$invalidate) {
    			...
    			switch (message.type) {
    				case "selection-change":
    					...
    					if (scope === "Selection Context") {
    						...
    						$$invalidate(0, selected_code = add_line_numbers(message.value, message.start_line));
    					}
    					break;
    			}
    		});
    	...
    	const updateStream = delta => {
    		if (delta != undefined) {
    			...
    			$$invalidate(3, responses = responses.map(response => {
    	...
    	const handleRemove = id => {
    		$$invalidate(3, responses = responses.filter(response => response.id !== id));
