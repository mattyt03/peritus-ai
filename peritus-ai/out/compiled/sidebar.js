var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "prompt svelte-bus4if");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "How may I assist you?");
    			add_location(input, file$4, 11, 4, 243);
    			attr_dev(div, "class", "container svelte-bus4if");
    			add_location(div, file$4, 10, 4, 215);
    			attr_dev(form, "class", "form svelte-bus4if");
    			add_location(form, file$4, 9, 0, 151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*i*/ ctx[6] % 2 === /*mod*/ ctx[1]) return create_if_block$3;
    ...
    // (33:6) {#each segments as segment, i}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:6) {#each segments as segment, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "close-btn svelte-1yw15qg");
    			add_location(button, file$1, 27, 2, 740);
    			attr_dev(div0, "class", "prompt svelte-1yw15qg");
    			add_location(div0, file$1, 30, 2, 851);
    			attr_dev(div1, "class", "response svelte-1yw15qg");
    			add_location(div1, file$1, 31, 2, 888);
    			attr_dev(div2, "class", "container svelte-1yw15qg");
    			add_location(div2, file$1, 26, 0, 714);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (146:2) {#each responses as res (res.id)}
    function create_each_block(key_1, ctx) {
    	...
    	response = new Response({
    			props: {
    				id: /*res*/ ctx[14].id,
    				prompt: /*res*/ ctx[14].prompt,
    				result: /*res*/ ctx[14].result,
    				onRemove: /*handleRemove*/ ctx[5]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const response_changes = {};
    			if (dirty & /*responses*/ 8) response_changes.id = /*res*/ ctx[14].id;
    			if (dirty & /*responses*/ 8) response_changes.prompt = /*res*/ ctx[14].prompt;
    			if (dirty & /*responses*/ 8) response_changes.result = /*res*/ ctx[14].result;
    			response.$set(response_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(146:2) {#each responses as res (res.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function input_prompt_binding(value) {
    		/*input_prompt_binding*/ ctx[6](value);
    	}

    	let input_props = {
    		selected_code: /*selected_code*/ ctx[0],
    		handleSubmit: /*streamResponse*/ ctx[4]
    	};
    	...
    	validate_each_argument(each_value);
    	const get_key = ctx => /*res*/ ctx[14].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(body, file, 138, 0, 5297);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*responses, handleRemove*/ 40) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const updateStream = delta => {
    		if (delta != undefined) {
    			...
    			$$invalidate(3, responses = [...responses]);
    		}
    	};
